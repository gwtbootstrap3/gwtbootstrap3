...
public class GroupValidator implements ValidationChangedEvent.HasValidationChangedHandlers {
	...
	/**
	 * Update the state of the validator and notify via {@link EventBus} any changed
	 * handlers.
	 */
	...
	/**
	 * Validate the group. This calls {@link Validator #validate(Editor, Object)} on
	 ...
	 *
	 * @param show
	 *            do we want to show the user the result of the validate via ui
	 *            marks?
	 * @return true, if successful
	 */
