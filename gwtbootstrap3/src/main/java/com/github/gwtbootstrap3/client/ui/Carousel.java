...
import com.github.gwtbootstrap3.client.shared.event.SlidEvent;
import com.github.gwtbootstrap3.client.shared.event.SlidHandler;
import com.github.gwtbootstrap3.client.shared.event.SlideEvent;
import com.github.gwtbootstrap3.client.shared.event.SlideHandler;
...
public class Carousel extends Div {
    ...
    private native void bindJavaScriptEvents(final com.google.gwt.dom.client.Element e) /*-{
        ...
        $carousel.on('slide.bs.carousel', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Carousel::onSlide(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $carousel.on('slid.bs.carousel', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Carousel::onSlid(Lcom/google/gwt/user/client/Event;)(evt);
        });
    }-*/;
