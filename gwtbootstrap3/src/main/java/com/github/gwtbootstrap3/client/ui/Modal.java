...
import com.github.gwtbootstrap3.client.shared.event.ModalHiddenEvent;
import com.github.gwtbootstrap3.client.shared.event.ModalHideEvent;
import com.github.gwtbootstrap3.client.shared.event.ModalShowEvent;
import com.github.gwtbootstrap3.client.shared.event.ModalShownEvent;
import com.github.gwtbootstrap3.client.ui.base.helper.StyleHelper;
import com.github.gwtbootstrap3.client.ui.base.modal.ModalContent;
import com.github.gwtbootstrap3.client.ui.base.modal.ModalDialog;
import com.github.gwtbootstrap3.client.ui.constants.Attributes;
import com.github.gwtbootstrap3.client.ui.constants.ModalBackdrop;
 ...
 * @see ModalBody
 * @see ModalFooter
 * @see com.github.gwtbootstrap3.client.shared.event.ModalShowEvent
 * @see com.github.gwtbootstrap3.client.shared.event.ModalShownEvent
 * @see com.github.gwtbootstrap3.client.shared.event.ModalHideEvent
 * @see com.github.gwtbootstrap3.client.shared.event.ModalHiddenEvent
 */
public class Modal extends FlowPanel implements IsClosable, HasResponsiveness {
     ...
     * @see com.github.gwtbootstrap3.client.ui.constants.ModalBackdrop
     */
    ...
    private native void bindJavaScriptEvents(final Element e) /*-{
        ...
        $modal.on('show.bs.modal', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Modal::onShow(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $modal.on('shown.bs.modal', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Modal::onShown(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $modal.on('hide.bs.modal', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Modal::onHide(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $modal.on('hidden.bs.modal', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Modal::onHidden(Lcom/google/gwt/user/client/Event;)(evt);
        });
    }-*/;
