...
import com.github.gwtbootstrap3.client.shared.event.*;
import com.github.gwtbootstrap3.client.ui.constants.Placement;
import com.github.gwtbootstrap3.client.ui.constants.Trigger;
...
public class Popover implements IsWidget, HasWidgets, HasOneWidget, HasId, HasHover {
     ...
     *
     * @param evt Event
     * @see com.github.gwtbootstrap3.client.shared.event.ShowEvent
     */
     ...
     *
     * @param evt Event
     * @see com.github.gwtbootstrap3.client.shared.event.ShownEvent
     */
     ...
     *
     * @param evt Event
     * @see com.github.gwtbootstrap3.client.shared.event.HideEvent
     */
     ...
     *
     * @param evt Event
     * @see com.github.gwtbootstrap3.client.shared.event.HiddenEvent
     */
    ...
    private native void bindJsEvents(final Element e) /*-{
        ...
        $popover.on('show.bs.popover', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Popover::onShow(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $popover.on('shown.bs.popover', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Popover::onShown(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $popover.on('hide.bs.popover', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Popover::onHide(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $popover.on('hidden.bs.popover', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Popover::onHidden(Lcom/google/gwt/user/client/Event;)(evt);
        });
    }-*/;
