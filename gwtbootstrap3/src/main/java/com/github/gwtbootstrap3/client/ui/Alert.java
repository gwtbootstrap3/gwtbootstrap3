...
import com.github.gwtbootstrap3.client.shared.event.AlertCloseEvent;
import com.github.gwtbootstrap3.client.shared.event.AlertClosedEvent;
import com.github.gwtbootstrap3.client.ui.base.button.CloseButton;
import com.github.gwtbootstrap3.client.ui.base.helper.StyleHelper;
import com.github.gwtbootstrap3.client.ui.constants.AlertType;
import com.github.gwtbootstrap3.client.ui.constants.ButtonDismiss;
 ...
 * @author Sven Jacobs
 * @author Joshua Godi
 * @see com.github.gwtbootstrap3.client.shared.event.AlertCloseEvent
 * @see com.github.gwtbootstrap3.client.shared.event.AlertClosedEvent
 */
public class Alert extends HTMLPanel implements HasType<AlertType>, HasResponsiveness {
    ...
    private native void bindJavaScriptEvents(final Element e) /*-{
        ...
        $alert.on('close.bs.alert', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Alert::onClose(Lcom/google/gwt/user/client/Event;)(evt);
        });

        $alert.on('closed.bs.alert', function (evt) {
            target.@com.github.gwtbootstrap3.client.ui.Alert::onClosed(Lcom/google/gwt/user/client/Event;)(evt);
        });
    }-*/;
}
